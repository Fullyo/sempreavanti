...
export const MAY_2026_BOOKINGS: HistoricalBooking[] = [
  ...
  {
    id: "hist-may-alatorre",
    guest: "Diego Alatorre",
    checkin: "2026-05-16",
    checkout: "2026-05-19",
    villa: "Villa Luisa",
    accommodationFare: 973.05,
    upsellsBilled: 0,
    upsellsProfit: 0,
    currency: "USD",
    notes: "3 nights · 8 adults, 1 infant · Ref HM25A548RR",
    monthKey: "2026-05",
  },
  {
    id: "hist-may-teresa",
  ...
  },
  {
    ...
    upsellsProfit: 0.00,
    currency: "USD",
    notes: "5 nights · 4 adults · Ref HM3KZYP9KW · Tip paid in cash directly to staff (excluded)",
    monthKey: "2026-05",
  },
  {
    id: "hist-may-garcia",
    ...
    upsellsBilled: 1760.50,
    upsellsProfit: 131.50,
    currency: "USD",
    notes: "4 nights · 7 adults, 1 child · Invoice #60 · Ref HM45CA4DB3 · Paid all upsells in cash",
    monthKey: "2026-05",
  },
];
