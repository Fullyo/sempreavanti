export function openMay2026Historical() {
  ...
  <div class="wrap">
    ...
    <div class="cards">
      ...
      <div class="card"><div class="label">Total Profit Pool</div><div class="value">$1,261.81</div></div>
      <div class="card owner"><div class="label">Owner's Share 85%</div><div class="value">$1,072.54</div></div>
      <div class="card lux"><div class="label">LUX's Cut 15%</div><div class="value">$189.27</div></div>
      <div class="card cash"><div class="label">Cash Collected</div><div class="value">$1,300.00</div></div>
    </div>
    ...
    <section class="booking">
      ...
      <table>
        <thead><tr><th>Item</th><th>Type</th><th style="text-align:right">Guest Paid</th><th style="text-align:right">Profit</th><th style="text-align:right">Owner 85%</th><th style="text-align:right">LUX 15%</th></tr></thead>
        <tbody>
          <tr><td>Airport SUV (Round Trip) <em style="color:#9E9080;font-size:11px">≈$1,000 MXN profit</em></td><td><span class="badge b-flat">Flat fee</span></td><td style="text-align:right">$395.00</td><td style="text-align:right">$50.00</td><td style="text-align:right;color:#2D6A45">$42.50</td><td style="text-align:right;color:#7A5C1E">$7.50</td></tr>
          <tr><td>Taxi <em style="color:#9E9080;font-size:11px">≈$1,000 MXN profit (same as airport)</em></td><td><span class="badge b-flat">Flat fee</span></td><td style="text-align:right">$290.00</td><td style="text-align:right">$50.00</td><td style="text-align:right;color:#2D6A45">$42.50</td><td style="text-align:right;color:#7A5C1E">$7.50</td></tr>
          <tr><td>Meal at the House <em style="color:#9E9080;font-size:11px">Chef after-hours</em></td><td><span class="badge b-15">15%</span></td><td style="text-align:right">$200.00</td><td style="text-align:right">$30.00</td><td style="text-align:right;color:#2D6A45">$25.50</td><td style="text-align:right;color:#7A5C1E">$4.50</td></tr>
          <tr><td>UTV Rental (Side-by-Side)</td><td><span class="badge b-15">15%</span></td><td style="text-align:right">$2,400.00</td><td style="text-align:right">$360.00</td><td style="text-align:right;color:#2D6A45">$306.00</td><td style="text-align:right;color:#7A5C1E">$54.00</td></tr>
          <tr><td>Groceries <em style="color:#9E9080;font-size:11px">$2,206 + $771 combined</em></td><td><span class="badge b-35">35% markup</span></td><td style="text-align:right">$2,977.00</td><td style="text-align:right">$771.81</td><td style="text-align:right;color:#2D6A45">$656.04</td><td style="text-align:right;color:#7A5C1E">$115.77</td></tr>
          <tr><td>Drinks &amp; Alcohol <em style="color:#9E9080;font-size:11px">Sold at cost — no margin charged this stay</em></td><td><span class="badge b-pass">Pass-through</span></td><td style="text-align:right">$232.00</td><td style="text-align:right">—</td><td style="text-align:right">—</td><td style="text-align:right">—</td></tr>
          <tr><td>Credit Card Fee</td><td><span class="badge b-pass">Pass-through</span></td><td style="text-align:right">$196.32</td><td style="text-align:right">—</td><td style="text-align:right">—</td><td style="text-align:right">—</td></tr>
        </tbody>
        <tfoot>
          <tr><td colspan="2" style="text-align:right">Totals</td><td style="text-align:right">$6,690.32</td><td style="text-align:right">$1,261.81</td><td style="text-align:right;color:#2D6A45">$1,072.54</td><td style="text-align:right;color:#7A5C1E">$189.27</td></tr>
        </tfoot>
      </table>
    ...
    <div class="grand">
      ...
      <div class="grand-grid">
        ...
        <div class="grand-cell"><div class="l">Upsell Revenue</div><div class="v">$6,690.32</div></div>
        <div class="grand-cell"><div class="l" style="color:#7DD89E">Owner's Share 85%</div><div class="v" style="color:#7DD89E">$1,072.54</div></div>
        <div class="grand-cell"><div class="l" style="color:#D4A96A">LUX's Cut 15%</div><div class="v" style="color:#D4A96A">$189.27</div></div>
      </div>
      ...
      <div style="margin-top:12px;font-size:10px;color:rgba(247,244,238,0.4)">All figures in USD · Accommodation fare excluded</div>
    </div>
  </div></body></html>`;
