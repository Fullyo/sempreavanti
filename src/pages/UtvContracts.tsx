...
const canamText = `═══════════════════════════════════════════════════════════════════
  COMMERCIAL OFF-ROAD VEHICLE RENTAL AGREEMENT
...
FUEL POLICY: The UTV is rented with a full tank of gas and must be returned with a full tank of gas. If the vehicle is not returned with a full tank of gas, a $1,500 MXN fee will be charged.
...
═══════════════════════════════════════════════════════════════════
  CONTRATO DE ARRENDAMIENTO DE VEHÍCULO TODOTERRENO COMERCIAL
...
2. TARIFA DE ARRENDAMIENTO Y POLÍTICA DE COMBUSTIBLE
...
POLÍTICA DE COMBUSTIBLE: El UTV se entrega con el tanque lleno de gasolina y debe devolverse con el tanque lleno de gasolina. Si el vehículo no se devuelve con el tanque lleno, se cobrará una tarifa de $1,500 MXN.
...
const contracts = [
  { id: "canam", label: "Can-Am UTV 2025", text: canamText, price: "$2,500 MXN / day" },
  { id: "polaris", label: "Polaris UTV 2024", text: polarisText, price: "$2,200 MXN / day" },
];
        ...
        <div className="container max-w-7xl">
          <div className="mb-10">
            ...
            <p className="text-sm font-sans text-muted-foreground max-w-2xl">
              Copy-and-paste templates for the Can-Am and Polaris UTV rental agreements (English & Spanish combined).
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            {contracts.map((c) => (
              <div key={c.id} className="bg-card border border-border rounded-lg p-5 flex items-center justify-between">
                <div>
                  <p className="text-xs uppercase tracking-widest text-muted-foreground mb-1">{c.label}</p>
                  <p className="font-serif text-2xl">{c.price.split(" ")[0]} {c.price.split(" ")[1]} <span className="text-sm font-sans text-muted-foreground">/ day</span></p>
                </div>
                <div className="text-right">
                  <p className="text-xs font-sans text-muted-foreground italic">2-day minimum rental</p>
                  <p className="text-xs font-sans text-muted-foreground italic">Prices subject to change</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {contracts.map((c) => (
              <div key={c.id}>
                <h2 className="font-serif text-2xl mb-4">{c.label}</h2>
